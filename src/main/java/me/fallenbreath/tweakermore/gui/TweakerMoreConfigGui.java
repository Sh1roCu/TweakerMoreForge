...
public class TweakerMoreConfigGui extends GuiConfigsBase {
    ...
    public TweakerMoreConfigGui() {
        super(10, 50, TweakerMoreForge.MOD_NAME, null, "tweakermore.gui.title", TweakerMoreMod.VERSION);
    }
    ...
    private boolean isValidOption(TweakerMoreOption option) {
        ...
        if (option.isDevOnly() && !(TweakerMoreConfigs.TWEAKERMORE_DEBUG_MODE.getBooleanValue() && PlatformUtils.isDevelopmentEnvironment())) {
            return false;
        }
        return true;
    }
    ...
    public void reDraw(boolean keepSearchBar) {
        ...
        if (this.searchBar != null && previousSearchBarText != null) {
            ...
            searchBox.insertText(previousSearchBarText);
