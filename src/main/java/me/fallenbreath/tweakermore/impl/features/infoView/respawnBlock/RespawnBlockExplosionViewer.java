...
public class RespawnBlockExplosionViewer extends CommonScannerInfoViewer {
    ...
    protected void render(RenderContext context, RenderVisitorWorldView world, BlockPos pos, boolean isCrossHairPos) {
        ...
        MutableComponent line1 = Messenger.tr("tweakermore.impl.infoViewRespawnBlockExplosion.damage", float2text.apply(cache.appliedAmount));
        MutableComponent line2 = Messenger.c("-> ", float2text.apply(cache.remainingHealth), "HP");
