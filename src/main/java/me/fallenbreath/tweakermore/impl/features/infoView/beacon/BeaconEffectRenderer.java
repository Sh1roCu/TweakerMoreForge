...
public class BeaconEffectRenderer extends CommonScannerInfoViewer {
    ...
    private double calculateRowWidth(MobEffect statusEffect, int amplifier) {
        double textWidth = RenderUtils.getRenderWidth(getStatusText(statusEffect, amplifier));
    ...
    private void renderStatusEffectIcon(Vec3 pos, MobEffect statusEffect, int amplifier, double deltaX, double kDeltaY) {
        ...
        positionTransformer.apply(renderContext);
        {
            ...
            // ref: net.minecraft.client.gui.hud.InGameHud#renderMobEffectOverlay
            ...
            //#elseif MC >= 11600
            //$$ renderContext.getGuiDrawer().blit(renderContext.getMatrixStack().asMcRaw(), 0, 0, 0, ICON_SIZE, ICON_SIZE, sprite);
            //#else
            // renderContext.getGuiDrawer().blit(RenderLayer::getParentModel, sprite, 0, 0, ICON_SIZE, ICON_SIZE);
            //#endif
    ...
    private void renderStatusEffectText(Vec3 pos, MobEffect statusEffect, int amplifier, double deltaX, double kDeltaY) {
        String description = getStatusText(statusEffect, amplifier);
