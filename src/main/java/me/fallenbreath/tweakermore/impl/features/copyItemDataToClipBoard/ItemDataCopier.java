...
public class ItemDataCopier {
    public static void copyItemData() {
        ...
        if (mc.screen instanceof AbstractContainerScreen) {
            Slot slot = ((ContainerScreenAccessor) mc.screen).getHoverdSlot();
            if (slot != null && slot.hasItem() && mc.level != null) {
                ...
                InfoUtils.printActionbarMessage("tweakermore.impl.copyItemDataToClipBoard.item_copied", itemStack.getItemName());
            }
        }
    }
}
