...
public abstract class SignEditScreenMixin extends Screen {
    ...
    //#elseif MC >= 11600
    @ModifyConstant(
            method = "m_169821_",  //lambda$init$5  srg: m_169821_
    ...
    //#if MC >= 11903
    //$$ private void drawLineOverflowHint(MatrixStack matrices, MultiBufferSource.BufferSource immediate, CallbackInfo ci, Vector3f vector3f, int i, boolean bl, int j, int k, int l, int m, Matrix4f matrix4f, int lineIdx, String string, float xStart)
    //#elseif MC >= 11700
    ...
    //#elseif MC >= 11600
    //$$ private void drawLineOverflowHint(MatrixStack matrices, int mouseX, int mouseY, float delta, CallbackInfo ci, float f, BlockState blockState, boolean bl, boolean bl2, float g, MultiBufferSource.BufferSource immediate, float h, int i, int j, int k, int l, Matrix4f matrix4f, int lineIdx, String string, float xStart)
    //#else
    //$$ private void drawLineOverflowHint(int mouseX, int mouseY, float delta, CallbackInfo ci, MatrixStack matrixStack, float f, BlockState blockState, boolean bl, boolean bl2, float g, MultiBufferSource.BufferSource immediate, float h, int i, String strings[], Matrix4f matrix4f, int k, int l, int m, int n, int lineIdx, String string, float xStart)
    //#endif
    {
        if (TweakerMoreConfigs.DISABLE_SIGN_TEXT_LENGTH_LIMIT.getBooleanValue()) {
            SignBlockEntity sign =
