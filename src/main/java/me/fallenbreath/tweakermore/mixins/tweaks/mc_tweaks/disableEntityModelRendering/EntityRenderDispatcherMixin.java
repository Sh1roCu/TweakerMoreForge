...
public abstract class EntityRenderDispatcherMixin {
    ...
    //#elseif MC >= 12103
    //$$ (EntityRenderer instance, S s, PoseStack renderState, MultiBufferSource poseStack, int bufferSource)
    //#elseif MC >= 11500
    (EntityRenderer<Entity> instance, Entity entity, float yaw, float tickDelta, PoseStack matrixStack, MultiBufferSource vertexConsumerProvider, int light)
    //#else
