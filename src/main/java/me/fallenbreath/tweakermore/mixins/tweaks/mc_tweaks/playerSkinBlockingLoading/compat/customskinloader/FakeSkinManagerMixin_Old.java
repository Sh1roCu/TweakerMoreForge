...
/**
 * The way to submit Runnable in { customskinloader.fake.FakeSkinManager#loadProfileTextures}
 ...
 */
@Restriction(require = @Condition(value = ModIds.custom_skin_loader, versionPredicates = ">14.11 <14.14-SNAPSHOT-336"))
@Pseudo
@Mixin(targets = "customskinloader.fake.FakeSkinManager")
public abstract class FakeSkinManagerMixin_Old {
