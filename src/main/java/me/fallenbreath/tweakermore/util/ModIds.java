...
public class ModIds
{
	...
	// masa's
	public static final String malilib = "mafglib";
	public static final String tweakeroo = "tweakerge";
	public static final String itemscroller = "rocknroller";
	public static final String litematica = "forgematica";
	public static final String minihud = "bocchud";
	...
	public static final String carpet = "bedsheet";
	...
	public static final String replay_mod = "reforgedplaymod";
